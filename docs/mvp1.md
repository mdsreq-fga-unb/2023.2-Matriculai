...
| Critérios de aceitação | Caso válido | Caso inválido | Passou? | Obs. |
| ------------- | ---------- | ---------- | ------- | -------- |
| Deve ser selecionada a trilha que deseja-se remover; | | |
| Deve ser confirmada a escolha de remover a trilha; | | |
| Deve ser apresentada uma mensagem de confirmação da remoção da trilha. | | |
...
| ------------- | ---------- | ---------- | ------- | -------- |
| Alto contraste | O alto contraste é acionado | Ao selecionar o alto contraste, ele não é acionado | | |
...
| Componete | Padão de cor | Padrão de fonte | Padrão de ícone | Passou? | Obs. |
| --------- | ---------- | ----------- | ----------------- | ----------- | --------- |
| Header | | | | | |
| Component | | | | |
| Footer | | | | |
...
| Título de arquivo no modelo nome_arquivo | | |
| Título de pasta no modelo nome_pasta | | |
| Nome de variáveis em português | | |
| Nome de variáveis no modelo nome_variável | | |
| Nome de funções no modelo Nome_Funcao | | |
