...
| Sprint Review | -Feedback:Tudo bem encaminhado,dentro dos conformes; Foco em fazer o programa e testar </br> - Prioridades para a próxima sprint: Analisar a possibilidade de ranqueamento por sorteio para solicitação de eletivas → 1º ao 30º por exemplo, terão um período para se matricular, senão, vão para o final da fila → lembrar de justificar essas questões |
| Débitos Técnicos | Ocorreu um atraso na review devido à indisponibilidade do cliente |
| Sprint Retrospective |-Pontos Fortes: Aumento do entrosamento da equipe;Entregas pontuais; Todos apresentaram </br> -Pontos Fracos: Falha em dividir atividades; Concentração de atividades em um grupo pequeno de pessoas; Falta de alinhamento para a execução de atividades e distribuição das mesmas; Pouca comunicação sobre quem está fazendo o que </br> -Pontos de Melhoria: Dividir as tarefas de maneira igual entre os membros pra não sobrecarregar ninguém; Se comunicar melhor no grupo sobre o que está fazendo |
...
| Cerimônia | Atividades da Sprint |
| ------------------------------------- | ----------------------------------------------------- |
| Sprint Planning | - Goal: Finalizar questões do backlog e definições gerais do projeto. |
| Backlog da Sprint | - (Análise e Consenso) Reduzir mais histórias e validar com o cliente. Responsáveis: Yan </br>- (Representação) Prototipação (Figma). Responsáveis: Júlia, Algusto.</br>- (Declaração) Definir arquitetura. Responsáveis: Luana, Yasmim e Julia. </br> - (Declaração) Correções critérios de aceitação. Responsável: Luana,Yan e Yasmim. </br>- (Declaração) Atualizar Pages. Responsáveis: Luana e Gabriel. </br>- (Representação) Padrões de Interface. Responsáveis: Julia, Algusto e Luana. |
| Sprint Review | -Feedback: Protótipo ok; Entrosamento tranquilo. </br> - Prioridades para a próxima sprint: Começar o desenvolvimento |
| Débitos Técnicos | Não houveram débitos técnicos nessa sprint |
| Sprint Retrospective |-Pontos Fortes: Equipe bem entrosada; Entregas mais acertivas </br> -Pontos Fracos: Mal gerenciamento do tempo; Dificuldade de comunicação com o cliente; Poucas atividades sendo realizadas em grupo </br> -Pontos de Melhoria: Podemos tentar organizar nossas demandas pra não gerar uma sobrecarga de demanda num dia só; Mais proatividade para assumir tarefas;Mais comunicação sobre o que cada um está fazendo no momento |
